...
<body class="fp-page">
    <div class="fp-box">
        ...
        <div class="card">
            <div class="body" style="background-color:#000">
                <form id="forgot_password">
                    <div class="msg">
                    <?php   
                    echo "Para terminar el proceso de registro siga las instrucciones que le hemos enviado a su correo electronico";
                    ?>
                    </div>
