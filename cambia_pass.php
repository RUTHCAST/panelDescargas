...
<body class="login-page" style="background-color:#000">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" action="guarda_pass.php" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="password" placeholder="Nueva Contraseña" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-red waves-effect" type="submit">MODIFICAR</button>
                        </div>
                    </div>
